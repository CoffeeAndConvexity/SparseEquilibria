...
def university_exp_patrolling_structured(depth, seed, output_dir: Path):
    ...
    s_hat = [[sp_indexes[s] for s in sp_indexes],[[i] for i in range(len(paths_minimizer))]]

    output_csv_path = output_dir / "structured_mip_output.csv"
...
if __name__== "__main__":
    try:
        ...
        university_exp_patrolling_structured(depth, seed, output_dir)
